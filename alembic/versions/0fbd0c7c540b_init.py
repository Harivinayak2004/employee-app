...
down_revision: Union[str, Sequence[str], None] = 'a13a08edbaba'
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['employee_id'], ['employees.id'], name=op.f('addresses_employee_id_fkey'), ondelete='CASCADE'),
